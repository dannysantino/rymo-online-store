    ...
    return (
        <>
            <section id='blog-home' className='container pt-5 mt-5'>
                <h2 className='fw-bold pt-5'>Blogs</h2>
                <hr />
            </section>
            ...
            <section id='blog-container' className='container pt-5'>
                <div className='row'>
                    <div className='post col-md-6 pb-5'>
                        ...
                        <h3 className='text-center fw-normal pt-3'>Five must-have Clothing Items for your Summer Wardrobe</h3>
                    ...
                    <div className='post col-md-6 pb-5'>
                        ...
                        <h3 className='text-center fw-normal pt-3'>Fashion-forward ideas Tailored to your Personal Needs</h3>
                        <p className='text-center'>Feb 19, 2021</p>
                    </div>
                    <div className='post col-md-6 pb-5'>
                        <div className='post-img'>
                    ...
                    <div className='post col-md-6 pb-5'>
                        ...
                        <h3 className='text-center fw-normal pt-3'>The Hottest New Trends in Modern Fashion</h3>
                        <p className='text-center'>Feb 19, 2021</p>
                    </div>

                    <div className='col-12 pb-5 mb-3 mb-sm-5'>
                        <div className='post-img'>
                            <img src='/img/blog/banner.webp' className='img-fluid w-100' alt='' />
                        </div>
                    </div>
                    ...
                    <div className='post col-12 col-lg-4 col-md-6 pb-5'>
                        ...
                        <h4 className='fw-normal pt-3'>Six Quick and Easy Tips to turn your Dress Collection Around</h4>
                    </div>
                    <div className='post col-12 col-lg-4 col-md-6 pb-5'>
                        <div className='post-img'>
                            <img src='/img/blog/3.webp' className='img-fluid w-100' alt='' />
                        </div>
                        <h4 className='fw-normal pt-3'>What the future holds for Fast Fashion</h4>
                    </div>
                    <div className='post col-12 col-lg-4 col-md-6 pb-5'>
                        <div className='post-img'>
                            <img src='/img/blog/2.webp' className='img-fluid w-100' alt='' />
                        </div>
                        <h4 className='fw-normal pt-3'>Check out our Hottest New and Exclusive Drops every Tuesday and
                            Thursday</h4>
                    </div>
                </div>
            </section>
