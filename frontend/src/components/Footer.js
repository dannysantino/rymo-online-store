                ...
                <div className='row pt-3 mx-auto'>
                    <div className='col-lg-3 col-md-6 mb-3 footer-one'>
                        ...
                        <p className='pt-3 pe-5'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt reiciendis vitae
                            tempora ad velit
                            nulla tempore placeat non?</p>
                    </div>
                    <div className='col-lg-3 col-md-4 mb-3 footer-one'>
                    ...
                    <div className='col-lg-3 col-md-4 footer-one'>
                        <h5 className='pb-2'>Instagram</h5>
                        <div className='row'>
                            <img src='/img/insta/1.jpg' className='img-fluid w-25 h-100 m-2' alt='' />
                            <img src='/img/insta/2.jpg' className='img-fluid w-25 h-100 m-2' alt='' />
                            <img src='/img/insta/3.jpg' className='img-fluid w-25 h-100 m-2' alt='' />
                            <img src='/img/insta/4.jpg' className='img-fluid w-25 h-100 m-2' alt='' />
                            <img src='/img/insta/5.jpg' className='img-fluid w-25 h-100 m-2' alt='' />
                        </div>
                    </div>
                </div>
                ...
                <div className='copyright mt-5'>
                    <div className='row container mx-auto'>
                        ...
                        <div className='col-lg-4 col-md-6 mb-2 text-nowrap'>
                            <p>Copyright &copy; 2022 | Danny Santino</p>
                        </div>
